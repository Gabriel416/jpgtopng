...
var FileConversion = function FileConversion(_ref) {
  ...
  var onDrop = function onDrop(acceptedFiles, rejectedFiles) {
    ...
    acceptedFiles.forEach(function (file) {
      ...
      var task = storageRef.child(file.name).put(file, metaData); // dispatch({
      //   type: "setFiles",
      //   payload: file
      // });
      // task
...
//# sourceMappingURL=index.js.144456607d97978a800d.hot-update.js.map